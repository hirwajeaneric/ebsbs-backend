...
import { createHospital, deleteHospital, getActiveHospitals, getAllHospitals, getHospital, getInactiveHospitals, searchHospitalsByBlood, updateHospital } from '../controllers/hospital.controller';
